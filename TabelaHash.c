...
int insereHash(Hash* ha, char trabalho[], int idPesquisador){
    ...
    if(ha->itens[pos] == NULL){
        ...
        ha->qtd++;
        return insere_lista_final(ha->itens[pos], trabalho, idPesquisador);
    }else{
        if(strcmp(ha->itens[pos]->trabalho,trabalho) == 0){
            ha->qtd++;
            return insere_lista_final(ha->itens[pos], trabalho, idPesquisador);
        }
        else{
            ...
            for(i = 0; i < ha->TABLE_SIZE; i++){
                ...
                if(ha->itens[newPos] == NULL){
                    ...
                    ha->qtd++;
                    return insere_lista_final(ha->itens[newPos], trabalho, idPesquisador);
                }
            }
        }
    }
    ...
    if(ha->itens[pos] == NULL){
        ...
        if(strcmp(ha->itens[pos]->trabalho,trabalho) == 0){
            ...
            for(i = 0; i < ha->TABLE_SIZE; i++){
                ...
                if(strcmp(ha->itens[newPos]->trabalho,trabalho) == 0){
